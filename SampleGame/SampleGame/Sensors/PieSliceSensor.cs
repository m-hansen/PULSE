...
namespace SampleGame
{
    public class PieSliceSensor : Sensor
    {
        ...
        public override void Update(List<GameAgent> agentAIList, Vector2 playerPos, float playerRot)
        {
            ...
            endPoint1 = Utils.CalculateRotatedMovement(new Vector2(0, -1), playerRot + Rotation1) * MaxDistance + playerPos;
        ...
        public override void Draw(SpriteBatch sprites, Vector2 startPoint, Rectangle visibleRect, SpriteFont font1)
        {
            if (Active)
            {
                ...
                {
                    DrawingHelper.DrawFastLine(startPoint - topLeftVisibleSpot, endPoint1 - topLeftVisibleSpot, Color.Yellow);
                    DrawingHelper.DrawFastLine(startPoint - topLeftVisibleSpot, endPoint2 - topLeftVisibleSpot, Color.Yellow);
                    DrawingHelper.DrawFastLine(endPoint1 - topLeftVisibleSpot, endPoint2 - topLeftVisibleSpot, Color.Red);
